...
export const assetData: Asset[] = [
  {
    ...
    xcnSupplyApy: new BigNumber('0.11720675342484096'),
    xcnBorrowApy: new BigNumber('4.17469243006608279'),
    ...
    xcnPerDay: new BigNumber('19999999'),
    cash: new BigNumber('10000000000000000000000'),
  ...
  },
  {
    ...
    xcnSupplyApy: new BigNumber('1.353105649796123742'),
    xcnBorrowApy: new BigNumber('1.670327607690572731'),
  ...
  },
  {
    ...
    xcnSupplyApy: new BigNumber('0.421719501189155143'),
    xcnBorrowApy: new BigNumber('0.522209972682294832'),
    collateralFactor: new BigNumber('0.8'),
  ...
  },
  {
    ...
    xcnSupplyApy: new BigNumber('0.678420831753642169'),
    xcnBorrowApy: new BigNumber('0.852697602175970714'),
    collateralFactor: new BigNumber('0.8'),
