...
export { default as getPriorVotes } from './queries/getPriorVotes';
export * from './queries/getPriorVotes';
export { default as useGetPriorVotes } from './queries/getPriorVotes/useGetPriorVotes';
