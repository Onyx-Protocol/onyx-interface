...
const getTokenBalances = async ({
  ...
  const getEth20Balances: GetTokenBalancesPromise = async () => {
  ...
  const promises: Promise<TokenBalance[]>[] = [getEth20Balances()];

  // Handle fetching ETH balance if it was requested
