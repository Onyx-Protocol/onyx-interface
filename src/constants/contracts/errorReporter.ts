/** Values copied from https://github.com/XcnProtocol/xcn-protocol/blob/develop/contracts/ErrorReporter.sol */
...
export enum XcnVaultProxyErrorReporterError {
  NO_ERROR,
  UNAUTHORIZED,
}

export enum XcnVaultProxyErrorReporterInfo {
  ACCEPT_ADMIN_PENDING_ADMIN_CHECK,
  ACCEPT_PENDING_IMPLEMENTATION_ADDRESS_CHECK,
  SET_PENDING_ADMIN_OWNER_CHECK,
  SET_PENDING_IMPLEMENTATION_OWNER_CHECK,
