...
export const styles = ({
  ...
  const getButtonVariantCss = (refVariant: Variant) => {
    ...
    if (refVariant === 'secondaryConnectWallet') {
      return css`
        background-color: ${theme.palette.button.wallet};
        color: ${theme.palette.interactive.walletBtnColor};
        border-color: ${theme.palette.button.wallet};
        padding: ${small ? theme.spacing(2, 3) : theme.spacing(2, 6)};
        border-radius: 25px;
    ...
    if (refVariant === 'primaryConnectWallet') {
      return css`
        background-color: ${theme.palette.button.wallet};
        color: ${theme.palette.interactive.walletBtnColor};
        border-color: ${theme.palette.button.wallet};
