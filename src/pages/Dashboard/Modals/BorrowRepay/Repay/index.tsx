...
import { useRepayOToken } from 'clients/api';
...
const Repay: React.FC<RepayProps> = ({ asset, onClose, isXcnEnabled }) => {
  ...
  const { mutateAsync: repay, isLoading: isRepayLoading } = useRepayOToken({
