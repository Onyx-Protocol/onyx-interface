...
const BorrowRepay: React.FC<BorrowRepayProps> = ({ onClose, asset, isXcnEnabled }) => {
  ...
  const tabsContent: TabContent[] = [
    {
      ...
      content: (
        <div css={styles.container}>
          <Repay asset={asset} onClose={onClose} isXcnEnabled={isXcnEnabled} />
        </div>
      ),
    },
  ];
  ...
  if (isAssetEnabled(asset.token.id)) {
    tabsContent.unshift({
      ...
      content: (
        <div css={styles.container}>
          <Borrow asset={asset} onClose={onClose} isXcnEnabled={isXcnEnabled} />
        </div>
      ),
    });
  }
